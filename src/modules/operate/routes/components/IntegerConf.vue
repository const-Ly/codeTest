  ...
  <div>
    ...
    <ul>
      <li>
        ...
        <el-input v-else class="w100 number-input" v-model="info.rule.minValue" v-only-num.integer="info.rule.minValue" :max-len="8" role="props" @blur="handleBlur"></el-input>
      </li>
      <li class="ma-t-10">
        最大值：
        <span v-if="fromConfReadonly">{{ info.rule.maxValue }}</span>
        <el-input v-else class="w100 number-input" v-model="info.rule.maxValue" v-only-num.integer="info.rule.maxValue" :max-len="8" role="props" @blur="handleBlur"></el-input>
      </li>
      <li class="ma-t-10">
