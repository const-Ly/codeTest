<template>
  <el-card class="box-card ma-t-10">
    <div slot="header" class="clearfix ma-b-20">
      <span>弹窗页面： {{tit}}</span>
      <router-link class="fr" :to="'/dialogManagement/newVisitors/childAdd/'+ param.sonPopCode">
    ...
    <el-table :data="list" style="width:100%" size="small">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <router-link :to="'/dialogManagement/newVisitors/childEdit/'+ param.sonPopCode +'/' + scope.row.sonNodeId">
