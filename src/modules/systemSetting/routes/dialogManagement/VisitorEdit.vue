...
export default {
  ...
  methods: {
    getDetail () {
      ...
      this.$service.systemSetting.dialogManagement.getDetail(params).then(res => {
        let detail = res
    ...
    submitModule () {
      ...
      this.$service.systemSetting.dialogManagement.updateConfig(params).then(res => {
        this.$message.success('提交成功')
        this.$router.push({path: '/dialogManagement'})
      })
    },
    goBack () {
      this.$router.push({path: '/dialogManagement'})
