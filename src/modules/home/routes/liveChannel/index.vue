  ...
  <div class="cms">
    ...
    <el-card class="ma-t-10">
      <div class="table-header clearfix">
        ...
        <el-button class="fr ma-l-20" type="primary" @click="windowOpen('/app/home/#/liveChannel/add')">添加</el-button>
      </div>
      <el-table :data="list" style="width:100%">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button type="text" @click="windowOpen(`/app/home/#/liveChannel/details/${scope.row.id}`)">查看</el-button>
            <el-button type="text" @click="windowOpen(`/app/home/#/liveChannel/edit/${scope.row.id}`)">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    getList (idx) {
      ...
      this.$service.home.liveChannel
        .getListLiveChannel(this.param)
        .then(res => {
